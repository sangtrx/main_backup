...
if __name__ == "__main__":
    ...
    for catId in tqdm(catIds):  ## loop từng class
        ...
        for imgId in tqdm(imgIds):
            try:
                del a_cv_img, a_plg, a_box, a_ctr, a_Sbox, a_iname
                del a_im, a_plg_img, a_plg_mask
                del res_im
                del a1_cv_img, a1_plg, a1_box, a1_ctr, a1_Sbox, a1_iname
                del a1_im, a1_plg_img, a1_plg_mask
                del a2_cv_img, a2_plg, a2_box, a2_ctr, a2_Sbox, a2_iname
                del a2_im, a2_plg_img, a2_plg_mask
                print(1)
            except:
                continue
            ...
            if flag_a1 != 1:
                ...
                ##### dán hình 
                paste_x1 = int(random.uniform(0,310)) # 960 - 960*2/3-10
                paste_y = 0 
            ...
            if flag_a1 != 1:
                ...
                a1_box[0] = paste_x1
                a1_box[1] = paste_y 
                # a1_box[2] = res_im.size[0] - a1_box[0] - 1
                # a1_box[3] = res_im.size[1] - a1_box[1] - 1
