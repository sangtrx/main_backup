...
if __name__ == "__main__":
    ...
    for catId in tqdm(catIds):  ## loop từng class
        ...
        for imgId in tqdm(imgIds):
            ...
            ##### dán hình 
            paste_x = int(random.uniform(970,960*2 - 960*2/3-10))
            paste_y = 0 
            ...
            if flag_a1 != 1:
                ...
                ##### dán hình 
                paste_x1 = int(random.uniform(0,960 - 960*2/3-10))
                paste_y = 0 
            ...
            if flag_a2 != 1:
                ...
                ##### dán hình 
                paste_x2 = int(random.uniform(960*2,960*3 - 960*2/3-10))
                paste_y = 0 
