            ...
            if (box_x1 >= 5 and box_x2 <= x2-x-5): # Only need to check 2left n right vertical line 
                ...
                if    x2-x-20<= box_x2 <= x2-x-5:
                    if hit_right == False and hit_left == True:
                        ...
                        frame_filename = f'{video_name}_{frame_count}.png'
                        frame_save_path = os.path.join('/mnt/tqsang/dot2_raw_frame_2', frame_filename)
                        ...
                        label_filename = f'{video_name}_{frame_count}.txt'
                        label_save_path = os.path.join('/mnt/tqsang/dot2_raw_frame_label_2', label_filename)
...
areas = {
    '1-15': [1319, 598, 1319+1000, 598+1000],
    '16-17': [1462,660,1000,1000],
    '18': [1451,674,1000,1000],
    '19-20': [1385,669,1000,1000],
    '21-36': [1185,611,1300,1300],
}

# Get all video files
video_files = glob.glob('/mnt/tqsang/dot2_vid_2/dot2_*.mp4')
...
for video_file in video_files:
    ...
    if 1 <= video_number <= 15:
        video_groups['1-15'].append(video_file)
    elif 16 <= video_number <= 17:
        video_groups['16-17'].append(video_file)
    elif video_number == 18:
        video_groups['18'].append(video_file)
    elif 19 <= video_number <= 20:
        video_groups['19-20'].append(video_file)
    elif 21 <= video_number <= 36:
        video_groups['21-36'].append(video_file)
