...
def register_chicken_part_model1():
    try:
        DatasetCatalog.get("chicken_part_model1_train")
    except:
        register_coco_instances("chicken_part_model1_train", {}, 
            "/mnt/tqsang/data_chick_part/output/train.json", 
            "/mnt/tqsang/data_chick_part/output/train"
        )
    try:
        DatasetCatalog.get("chicken_part_model1_val")
    except:
        register_coco_instances("chicken_part_model1_val", {}, 
            "/mnt/tqsang/data_chick_part/output/val.json", 
            "/mnt/tqsang/data_chick_part/output/val"
        )
    try:
        DatasetCatalog.get("chicken_part_model1_test")
    except:
        register_coco_instances("chicken_part_model1_test", {}, 
            "/mnt/tqsang/data_chick_part/output/val.json", 
            "/mnt/tqsang/data_chick_part/output/val"
        )
    try:
        meta = MetadataCatalog.get('chicken_part_model1_train')
        meta.thing_classes =['0', '1', '2', '3', '4', '5', '6', '7', '8']
        meta = MetadataCatalog.get('chicken_part_model1_val')
        meta.thing_classes =['0', '1', '2', '3', '4', '5', '6', '7', '8']
        meta = MetadataCatalog.get('chicken_part_model1_test')
        meta.thing_classes =['0', '1', '2', '3', '4', '5', '6', '7', '8']
    except:
        pass
