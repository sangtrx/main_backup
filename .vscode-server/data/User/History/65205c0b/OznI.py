...
def process_video(model, video_path, output_path, area):
    ...
    while cap.isOpened():
        ...
        #  draw a black box with opacity of 70% right next to the main area to display counts later
        cv2.rectangle(output_frame, (x2 + 10, y), (x2+350, y2), (0,0,0), -1, cv2.LINE_AA, 0.7)
