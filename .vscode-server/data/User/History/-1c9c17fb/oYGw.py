...
def register_all_chick(root="/home/tqsang/fewshot/iFS-RCNN/datasets"):
    ...
    METASPLITS = [
        ...
        ("chick_test_all", "chick_fewshot/img", "chick_fewshot/feather_val.json"), # wrong json
        ("chick_test_base", "chick_fewshot/img", "chick_fewshot/feather_val.json"), # wrong json
        ("chick_test_novel", "chick_fewshot/img", "chick_fewshot/feather_val.json"),
    ]


    METASPLITS.append(("full_box_30shot_feather_trainval", "chick_fewshot/img",  "chick_fewshot/full_box_33shot_feather_trainval.json"))
