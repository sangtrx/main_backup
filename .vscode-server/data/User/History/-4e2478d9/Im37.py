...
def process_xml_file(xml_path, frame_number, areas, img_folder, json_data, img_id, ann_id):
    ...
    cropped_areas = {}  # keep track of cropped areas and their corresponding image ids
    ...
    for obj in root.findall("object"):
        ...
        if str(crop_area) not in cropped_areas:
            ...
            cropped_areas[str(crop_area)] = img_id
            img_id += 1

        current_img_id = cropped_areas[str(crop_area)]
...
for part, (xml_folder, img_folder, xml_files, max_frame, train_split, areas) in enumerate([
    ...
    for i, xml_file in enumerate(xml_files):
        ...
        img_id, ann_id = process_xml_file(xml_path, frame_number, areas, img_folder, json_data, img_id, ann_id)
