...
result = np.concatenate((panoptic_result, instance_result, semantic_result), axis=0)[:, :, ::-1]cv2.imwrite(str('/home/tqsang/Mask2Former/output_coco_2880to256to256_panoptic_/'), result)