    ...
    def __init__(self, p=1.0):
        ...
        try:
            ...
            T = [
                ...
                A.RandomGamma(p=0.4),
                A.ImageCompression(quality_lower=80, p=0.4),  # transforms
                # A.RandomRotate90(p=0.5)
                # A.SafeRotate(limit=90, interpolation=1, border_mode=4, value=None, mask_value=None, always_apply=False, p=0.5) #v2
                Rotate (limit=90, interpolation=1, border_mode=4, value=None, mask_value=None, rotate_method='largest_box', crop_border=False, always_apply=False, p=0.5)
            ]
