'Calculate and classify type of feather based on area and carcass area'
import cv2
import glob
import os
import numpy as np
...
def FEATHER_perform_inference_and_draw_boxes(img, output_frame):
    ...
    cv2.drawContours(output_frame, feather_contours, -1, (0, 0, 255), 2)
    cv2.drawContours(output_frame, feather_on_skin_contours, -1, (0, 255, 0), 2)
