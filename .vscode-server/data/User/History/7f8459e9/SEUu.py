...
output_directory = '/mnt/tqsang/dot2_test/test_dot3_vids_noshow'
...
for group, videos in video_groups.items():
    for video in videos:
            print(video)
            process_video(model, video, f'/mnt/tqsang/dot2_test/test_dot3_vids_noshow/{video.split("/")[-1]}', areas[group])
