...
def perform_inference_and_draw_boxes(model, img, output_frame, color, part_name, ii):
...
model_paths = {
    ...
    'feather on skin': '/home/tqsang/JSON2YOLO/feather_YOLO_det/runs/detect/yolov8x_brio_feather_det_512_NoRotate_dot2_2/weights/best.pt',
...
for image_path in glob.glob(os.path.join(image_directory, '*.png')):
    ...
    for i, (part, model) in enumerate(models.items()):
        ...
        part_count = perform_inference_and_draw_boxes(model, img, output_frame, color, part, i)
