...
model_path = '/mnt/tqsang/data_chick_part_YOLO/runs/detect/yolov8n_default_rot/weights/best.pt'
model = YOLO(model_path)

video_path_part1 = '/mnt/tqsang/part1-test.mp4'
video_path_part2 = '/mnt/tqsang/part2-test.mp4'

output_path_part1 = '/mnt/tqsang/part1-test-outputn.mp4'
output_path_part2 = '/mnt/tqsang/part2-test-outputn.mp4'
