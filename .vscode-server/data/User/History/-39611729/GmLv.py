...
def process_video(model, input_video, output_video, areas):
    ...
    while cap.isOpened():
        ...
        for idx, area in enumerate(areas):
            ...
            results = model.predict(cropped_frame_pil, conf=0.8)
...
input_video_part1 = "/mnt/tqsang/part1-test.mp4"
input_video_part2 = "/mnt/tqsang/part2-test.mp4"

output_video_part1 = "/mnt/tqsang/part1-test_output_chick_x.mp4"
output_video_part2 = "/mnt/tqsang/part2-test_output_chick_x.mp4"
