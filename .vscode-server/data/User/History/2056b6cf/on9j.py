    ...
    while cap.isOpened():
        ...
        if success:
            ...
            if len(results_hand[0].boxes) == 0:
                ...
                output_frame[:height, :, :] = annotated_frame            
            ...
            if len(results_hand[0].boxes) == 0:
                for i, area in enumerate(areas):
                    ...
                    results_chicken = model_chicken(cropped_frame, conf=0.8)
...
model_hand = YOLO("/mnt/tqsang/hand_dataset_YOLO/runs/detect/yolov8x_full_aug_bz16/weights/best.pt")
model_chicken = YOLO("/mnt/tqsang/data_chick_part_YOLO/runs/detect/yolov8x_hand_full_aug_v3_256_bs1/weights/best.pt")
...
output_video_path_part1 = "/mnt/tqsang/output_part1x.mp4"
output_video_path_part2 = "/mnt/tqsang/output_part2x.mp4"
