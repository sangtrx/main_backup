...
_PREDEFINED_SPLITS_COCO_PANOPTIC = {
    "front2class_2017_train_panoptic_new": (
    ...
    "front2class_2017_val_panoptic_new": (
...
def register_all_front2class_new(root):
    ...
    try:
        meta = MetadataCatalog.get('front2class_2017_train_panoptic_new')
        meta.thing_classes =['normal','defect']
        meta = MetadataCatalog.get('front2class_2017_val_panoptic_new')
        meta.thing_classes =['normal','defect']
    except:
        pass
