...
def main():
    ...
    for name, frames_folder, xml_folder, max_frame_number, areas in [
        ...
        for ann in annotations:
            if ann["image_id"] in [img["id"] for img in images if img["file_name"].split('_')[1] in train_xml_files]:
                train_annotations.append(ann)
            elif ann["image_id"] in [img["id"] for img in images if img["file_name"].split('_')[1] in val_xml_files]:
