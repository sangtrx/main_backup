...
def main():
    ...
    for name, frames_folder, xml_folder, max_frame_number, areas in [
        ...
        images, annotations = save_coco_dataset(name, xml_folder, frames_folder, xml_files, train_xml_files, output_train_folder, output_val_folder, areas, image_id=image_id, annotation_id=annotation_id)
