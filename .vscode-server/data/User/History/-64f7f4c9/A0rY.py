...
def train_model(model, criterion, optimizer, scheduler, num_epochs=500, early_stop_epochs=20):
    since = time.time()
...
criterion = nn.functional.sigmoid_focal_loss()
...
# Specify a path
PATH = "resnet50_cls_sync_focal.pt"
