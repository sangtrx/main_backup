...
if __name__ == '__main__':
    ...
    for vid_name in tqdm(vid_names):
        ...
        while success:
            ...
            ret,blue_thresh_down = cv2.threshold(blue_imgray_down, 60,255,cv2.THRESH_BINARY) #### 44 calib
            ret,blue_thresh_up = cv2.threshold(blue_imgray_up, 70,255,cv2.THRESH_BINARY) ## 80 càng lớn càng mất 
