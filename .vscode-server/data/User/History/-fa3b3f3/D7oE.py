...
if __name__ == '__main__':
    ...
    for vid_name in tqdm(vid_names):
        ...
        frame_folder = '/home/tqsang/V100/tqsang/crop_obj/front_2_class_vis'
        ...
        while success:
            ...
            ret,green_thresh_down = cv2.threshold(green_imgray_down, 20,255,cv2.THRESH_BINARY) #### 44 calib
            ret,green_thresh_up = cv2.threshold(green_imgray_up, 23,255,cv2.THRESH_BINARY) ## 80 càng lớn càng mất 
            ...
            ret,blue_thresh_down = cv2.threshold(blue_imgray_down, 20,255,cv2.THRESH_BINARY) #### 44 calib
            ret,blue_thresh_up = cv2.threshold(blue_imgray_up, 23,255,cv2.THRESH_BINARY) ## 80 càng lớn càng mất 
