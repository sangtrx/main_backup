...
destination_dir = '/home/tqsang/JSON2YOLO/feather_YOLO_det/datasets/train/images'
labels_dir = '/home/tqsang/JSON2YOLO/feather_YOLO_det/datasets/train/labels'
...
for txt_file in txt_files:
    ...
    if os.path.exists(source_file_path):
        ...
        print(f"WARNING: Corresponding .jpg file not found for {txt_file}")
