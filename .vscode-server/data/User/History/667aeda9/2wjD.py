...
if __name__ == '__main__':
    ...
    for vid_name in tqdm(vid_names):
        ...
        while success:
            ...
            ret,red_thresh_up = cv2.threshold(red_imgray_up, 50,255,cv2.THRESH_BINARY) ## 80 càng lớn càng mất 
            ...
            ret,thresh_down = cv2.threshold(imgray_down, 80 ,255,cv2.THRESH_BINARY) #### 80 calib
            ret,thresh_up = cv2.threshold(imgray_up, 100,255,cv2.THRESH_BINARY) ## 70 càng lớn càng mất 
            ...
            cv2.imwrite(os.path.join(frame_folder, '%d_imgray_thresh3.jpg' % n_frames), thresh)
