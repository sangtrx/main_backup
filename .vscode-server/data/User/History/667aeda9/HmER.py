...
if __name__ == '__main__':
    ...
    for vid_name in tqdm(vid_names):
        ...
        while success:
            ...
            ret,red_thresh_up = cv2.threshold(red_imgray_up, 40,255,cv2.THRESH_BINARY) ## 80 càng lớn càng mất 
            ...
            ret,thresh_up = cv2.threshold(imgray_up, 110,255,cv2.THRESH_BINARY) ## 70 càng lớn càng mất 
