...
if __name__ == '__main__':
    vid_dir_out = '/mnt/tqsang/smart_plant/videos_out/'
    vid_dir = '/mnt/tqsang/smart_plant/videos/'
    frame_dir = '/mnt/tqsang/smart_plant/frames/'
    ...
    for vid_name in tqdm(vid_names):
        ...
        out = cv2.VideoWriter(os.path.join(vid_dir_out,'out_video_detect_count.avi'), fourcc, fps, (frame_width,frame_height))
