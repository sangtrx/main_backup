...
def process_video(model, video_path, output_path, area):
    ...
    while cap.isOpened():
        ...
        cv2.putText(output_frame, f"Avg feathers count: {featheravg_count}", (x, y-80), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0,0,255), 2)
        cv2.putText(output_frame, f"Defect count: {defect_count}", (x, y-50), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0,0,255), 2)
        cv2.putText(output_frame, f"Normal count: {normal_count}", (x, y-20), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0,255,0), 2)
