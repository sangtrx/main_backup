...
def process_images(dataset_path, new_dataset_path, sync_normal=False, shift_pixels=0):
    for filename in os.listdir(dataset_path):
        ...
        # Save the new image
        save_name = filename if not sync_normal else f"{filename.split('.')[0]}_{shift_pixels}.jpg"
...
new_base_path = '/home/tqsang/JSON2YOLO/carcass_brio_YOLO_det_only/datasets_classification_pad'
