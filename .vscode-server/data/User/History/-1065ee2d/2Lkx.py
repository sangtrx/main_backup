...
most_common_hist_rgb = cv2.cvtColor(np.uint8([[most_common_hist]*100]), cv2.COLOR_GRAY2RGB)

# Copy the histogram to the reference frame
reference_frame = most_common_hist_rgb.copy()
