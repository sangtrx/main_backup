            ...
            with open((fn / f).with_suffix('.txt'), 'a') as file:
                for i in range(len(bboxes)):
                    ...
                    if line[0] is not None:
                        ...
                        print(f'Skipping line due to None value: {line}')
...
if __name__ == '__main__':
    ...
    if source == 'COCO':
        convert_coco_json('/home/tqsang/V100/tqsang/crop_obj/front_2_class_1chick1img/annotations',  # directory with *.json
                          use_segments=False, #line nay
                          cls91to80=True)
