...
if __name__ == '__main__':
    ...
    frame_dir = '/mnt/tqsang/V100/tqsang/smart_plant/frames_data/'
    ...
    for vid_name in tqdm(vid_names):
        ...
        rf = Roboflow(api_key="8ldLxI9xhAc1POq0qSrN")
        project = rf.workspace().project("chick")
        ...
        path = '/home/tqsang/V100/tqsang/crop_obj/chick-1'
        data = ImageDataBunch.from_folder(path, size=224, num_workers=4).normalize(imagenet_stats)

        from fastai.metrics import error_rate # 1 - accuracy
        learn = create_cnn(data, models.resnet34, metrics=error_rate)

        learn.load('/home/tqsang/V100/tqsang/crop_obj/best_resnet34_1')
        ...
        out = cv2.VideoWriter(os.path.join(vid_dir_out,'out_video_inf.avi'), fourcc, fps, (frame_width,frame_height))
        ...
        while success:
            ...
            # _,contours = cv2.findContours(dilated,cv2.RETR_LIST,cv2.CHAIN_APPROX_SIMPLE)
            ...
            if (940 + best_box[0] > 940) and (940 + best_box[2] < 940 + 1400):
                ...
                cv2.imwrite('buffer.jpg', save_frame)

                img = open_image('buffer.jpg')
