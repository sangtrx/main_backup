...
def get_coco_from_labelme_folder(
    ...
    for json_path in tqdm(
        ...
        for shape in data["shapes"]:
            ...
            if category_name == 'Feather':
                category_name = 'feather'
            
            # if category_name in ['b5','1','2','Back','f1','thh','hanging neck skinn','fe1','fe','6','ripped back','b']:
            # if category_name in ['b5','1','2','Back','f1','thh','hanging neck skinn','fe1','fe','6','ripped back','b','tail','bone']:
            # if category_name in ['b5','1','2','Back','f1','thh','hanging neck skinn','fe1','fe','6','ripped back','b','tail','bone','wing','neck','back','thigh','leg','tailbone','backbone']:
            #     continue



            if category_name == 'ripped wing':
                category_name = 'broken wing'

            if 'skin' in category_name:
                category_name = 'skin'

            if category_name not in ['broken wing','wing','feather','skin']:
                continue
