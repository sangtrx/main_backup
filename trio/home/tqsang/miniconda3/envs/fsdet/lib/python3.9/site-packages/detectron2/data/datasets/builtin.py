...
from .meta_chick import register_meta_chick
...
def register_all_coco(root="/home/tqsang/fewshot/iFS-RCNN/datasets"):
...
def register_all_chick(root="/home/tqsang/fewshot/iFS-RCNN/datasets"):
    # register meta datasets
    METASPLITS = [
        (
            "chick_trainval_all",
            "chick_fewshot/img",
            "chick_fewshot/instances_train2023.json",
        ),
        (
            "chick_trainval_base",
            "chick_fewshot/img",
        ...
        ("chick_test_all", "chick_fewshot/img", "chick_fewshot/instances_val2023.json"), # wrong json
        ("chick_test_base", "chick_fewshot/img", "chick_fewshot/instances_val2023.json"), # wrong json
        ("chick_test_novel", "chick_fewshot/img", "chick_fewshot/feather_val.json"),
    ]


    METASPLITS.append(("chick_trainval_novel_30shot", "chick_fewshot/img",  "chick_fewshot/full_box_33shot_feather_trainval.json"))

    for name, imgdir, annofile in METASPLITS:
        register_meta_coco(
            name,
            _get_builtin_metadata("chick_fewshot"),
            os.path.join(root, imgdir),
            os.path.join(root, annofile),
        )
