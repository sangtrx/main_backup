...
class Translator(object):
    ...
    def translate_batch_greedy(self, input_ids_list, video_features_list, input_masks_list, token_type_ids_list,
        ...
        def greedy_decoding_step(prev_ms_, input_ids, video_features, input_masks, token_type_ids,
            ...
            ##### đo FLOPS
            def prepare_input(prev_ms_, input_ids, video_features, input_masks, token_type_ids):
            ...
            flops, params = get_model_complexity_info(model.forward_step, input_res=(1, 224, 224), 
                                        input_constructor= prepare_input(prev_ms_, input_ids, video_features, input_masks, token_type_ids),
