...
# IMG_DIR = '/mnt/tqsang/chicken_part/frames'
# ANNOT_FILE = '/mnt/tqsang/chicken_part/val.json'
# SAVE_DIR = '/mnt/tqsang/chicken_part/vis_gt'
IMG_DIR = '/home/tqsang/V100/tqsang/crop_obj/front_2_class_feather/train2017'
ANNOT_FILE = '/home/tqsang/V100/tqsang/crop_obj/front_2_class_feather/annotations/instances_train2017.json'
SAVE_DIR = '/home/tqsang/V100/tqsang/crop_obj/front_2_class_feather/vis_gt'
COLOR_MAP = {}
BLEND_RATIO = 0.4
cats_to_vis = [3] 
...
def main():
    ...
    for imgId in coco.imgs:
        ...
        for i, ann in enumerate(anns):
            ...
            cv2.rectangle(draw_img, start_point, end_point, colors[ann['category_id']], 2)
