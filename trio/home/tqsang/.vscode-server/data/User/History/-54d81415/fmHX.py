...
def register_local_defect():
    ...
    try:
        ...
        meta.thing_classes =['hanging neck skin','broken wing','hanging back skin', 'Feather', 'back bone', 'ripped wing', 'hanging breast skin', 'back with skin', 'hanging neck skin', 'ripped back'  ]
