...
def register_chick_combine():
    try:
        DatasetCatalog.get("chick_dataset_train_combine")
    except:
        register_coco_instances("chick_dataset_train_combine", {}, 
            "/home/tqsang/V100/tqsang/crop_obj/front_2_class_combine/annotations/instances_train2017.json", 
            "/home/tqsang/V100/tqsang/crop_obj/front_2_class_combine/train2017"
        )
    try:
        DatasetCatalog.get("chick_dataset_val_combine")
    except:
        register_coco_instances("chick_dataset_val_combine", {}, 
            "/home/tqsang/V100/tqsang/crop_obj/front_2_class_combine/annotations/instances_val2017.json", 
            "/home/tqsang/V100/tqsang/crop_obj/front_2_class_combine/val2017"
        )
    try:
        DatasetCatalog.get("chick_dataset_test_combine")
    except:
        register_coco_instances("chick_dataset_test_combine", {}, 
            "/home/tqsang/V100/tqsang/crop_obj/front_2_class_combine/annotations/instances_test2017.json", 
            "/home/tqsang/V100/tqsang/crop_obj/front_2_class_combine/test2017"
        )
    try:
        meta = MetadataCatalog.get('chick_dataset_train_combine')
        meta.thing_classes =['normal','defect']
        meta = MetadataCatalog.get('chick_dataset_val_combine')
        meta.thing_classes =['normal','defect']
        meta = MetadataCatalog.get('chick_dataset_test_combine')
        meta.thing_classes =['normal','defect']
    except:
        pass
