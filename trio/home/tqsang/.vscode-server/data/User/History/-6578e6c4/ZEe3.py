...
if __name__ == '__main__':
    ...
    frame_dir = '/mnt/tqsang/smart_plant/frames/back'
    ...
    for vid_name in tqdm(vid_names):
        ...
        frame_folder = '/home/tqsang/V100/tqsang/crop_obj/back_test'
        ...
        while success:
            ...
            cv2.imwrite(os.path.join(frame_folder, 'vis/%d.jpg' %(n_frames)), middle_frame) #### mask
