    ...
    for vid_name in tqdm(vid_names):
        ...
        while success:
            ...
            if (940 + best_box[0] > 940) and (940 + best_box[2] < 940 + 1400):
                ...
                cv2.imwrite(os.path.join(frame_folder, '%d_%d_obj.jpg' %(n_frames,chick_count)), save_frame)

                cv2.imwrite(os.path.join(frame_folder, '%d_%d.jpg' %(n_frames,chick_count)), middle_frame)
