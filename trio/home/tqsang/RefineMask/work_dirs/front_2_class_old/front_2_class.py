...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/home/tqsang/V100/tqsang/crop_obj/front_2_class/instances_train2017.json',
    ...
    val=dict(
        type='CocoDataset',
        ann_file=
        '/home/tqsang/V100/tqsang/crop_obj/front_2_class/instances_val2017.json',
...
workflow = [('train', 1)]
gpu_ids = range(0, 1)
work_dir = 'work_dirs/front_2_class'
load_from = None
resume_from = None
