...
IMG_DIR = '../data/std_data/AHP_coco_synthetic/train2017'
ANNOT_FILE = '../data/std_data/AHP_coco_synthetic/annotations/instances_train2017.json'
SAVE_DIR = '../data/std_data/AHP_coco_synthetic/vis'
COLOR_MAP = {}
BLEND_RATIO = 0.4
cats_to_vis = [3] 
