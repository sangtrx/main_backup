...
if __name__ == "__main__":
    ...
    dataDir = "../data/std_data/AHP_coco"
    add_dataDir = "../data/std_data/coco_tv"
    ...
    syn_dataDir = "../data/std_data/AHP_coco_synthetic"
    ...
    for catId in tqdm(catIds):
        ...
        for imgId in tqdm(imgIds):
            ...
            for _ in range(N_RAND_IMAGES):
                ...
                res_im = m_im.copy()
                scale_w = res_im.size[0] / a_im.size[0]
                scale_h = res_im.size[1] / a_im.size[0]
                ...
                rand_x = random.choice([
                        random.uniform(m_ctr['x'] , m_ctr['x'] + (m_box[2] / 4)),
                        random.uniform(m_ctr['x'] - (m_box[2] / 4), m_ctr['x'])
                    ])
                rand_y = random.choice([
                        random.uniform(m_ctr['y'] , m_ctr['y'] + (m_box[3] / 4)),
                        random.uniform(m_ctr['y'] - (m_box[3] / 4), m_ctr['y'])
                    ])
                paste_x = int(rand_x)
                paste_y = int(rand_y)
