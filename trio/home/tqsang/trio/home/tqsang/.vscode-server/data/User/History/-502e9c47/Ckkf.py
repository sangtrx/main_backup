        ...
        for _step, batch in enumerate(data_loader):
            ...
            with autocast(enabled=self.cfg.fp16_val):
                if self.cfg.recurrent:
                    ...
                    # global input_ids_list_, video_features_list_, input_masks_list_, token_type_ids_list_, input_labels_list_
                    # input_ids_list_, video_features_list_, input_masks_list_, token_type_ids_list_, input_labels_list_ = input_ids_list, video_features_list, input_masks_list, token_type_ids_list, input_labels_list
                    # ##### đo FLOPS
                    ...
                    #     global input_ids_list_, video_features_list_, input_masks_list_, token_type_ids_list_, input_labels_list_
                    #     x1 = input_ids_list_
                    #     x2 = video_features_list_
                    #     x3 = input_masks_list_
                    #     x4 = token_type_ids_list_
                    #     x5 = input_labels_list_                    
                    #     return dict(input_ids_list = x1, video_features_list=x2, input_masks_list=x3, token_type_ids_list=x4, input_labels_list=x5)
                    ...
                    flop_counter = FlopCountAnalysis(self.model, input)

                    giga_flops = flop_counter.total()/1e9
                    print(giga_flops/ len(input_ids_list))
