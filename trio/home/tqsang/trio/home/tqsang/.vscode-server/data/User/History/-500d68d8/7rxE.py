...
if __name__ == "__main__":
    ...
    for catId in tqdm(catIds):  ## loop từng class
        ...
        for imgId in tqdm(imgIds):
            ...
            a_box[0] = 950 - a_box[0] + paste_x ## trừ tọa độ cũ rồi mới shift

            smooth_a_plg[:, 0] += paste_x 
            # smooth_a_plg[:, 0] += int(a_box[0])
            ...
            if flag_a1 != 1:
                ...
                a1_box[0] = 950 - a1_box[0] + paste_x1 ## trừ tọa độ cũ rồi mới shift
            ...
            if flag_a2 != 1:
                ...
                a2_box[0] = 950 - a2_box[0] + paste_x2 ## trừ tọa độ cũ rồi mới shift
