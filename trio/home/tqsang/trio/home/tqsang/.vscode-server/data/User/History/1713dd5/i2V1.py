...
if __name__ == "__main__":
    ...
    syn_dataDir = "/home/tqsang/V100/tqsang/crop_obj/syn_vis"
    ...
    for catId in tqdm(catIds):  ## loop từng class
        ...
        for imgId in tqdm(imgIds):
            try:
                ...
                a_plg_img.save('/home/tqsang/V100/tqsang/crop_obj/syn_vis/'+ a_iname +'.png','PNG')
                # continue
            except:
                continue
            ...
            res_im.paste(a_plg_img, 
                            (paste_x, paste_y), 
                            mask=a_plg_mask)
            res_im.save('/home/tqsang/V100/tqsang/crop_obj/syn_vis/'+ a_iname + 'dan1'+'.jpg')
            ...
            res_im.save('/home/tqsang/V100/tqsang/crop_obj/syn_vis/'+ a_iname + 'lamdep'+'.jpg')
            ...
            if flag_a1 != 1:
                ...
                paste_x1 = int(random.uniform(600,750)) # 960 - 960*2/3-10
                paste_y = 0 
