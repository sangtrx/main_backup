...
def register_local_defect():
    try:
        ...
        register_coco_instances("local_defect_train", {}, 
            "/home/tqsang/local_defect/labelme2coco/train.json", 
            "/mnt/tqsang/andre_files"
        )
    try:
        DatasetCatalog.get("local_defect_val")
    except:
        register_coco_instances("local_defect_val", {}, 
            "/home/tqsang/local_defect/labelme2coco/val.json", 
            "/mnt/tqsang/andre_files"
        )

    try:
        meta = MetadataCatalog.get('local_defect_train')
        meta.thing_classes =['feather', 'wing', 'hanging neck skin', 'neck', 'back', 'thigh', 'tailbone', 'leg', 'broken wing', 'hanging back skin', 'Feather', 'back bone', 'tail', 'bone', 'ripped wing', 'hanging breast skin', 'back with skin', 'b5', '1', '2', 'Back', 'f1', 'thh', 'hanging neck skinn', 'fe1', 'fe', '6', 'ripped back', 'b']
