...
if __name__ == "__main__":
    ...
    syn_dataDir = "/home/tqsang/V100/tqsang/crop_obj/front_2_class_pad_COCO_synthetic_left"
    ...
    for catId in tqdm(catIds):  ## loop từng class
        ...
        for imgId in tqdm(imgIds): ## loop từng image
            # get main ones
            ...
            for index_thutu in range(N_RAND_IMAGES):
                ...
                if oke == 1: # right
                    ...
                    #                         m_ctr['x'] - 720)
                    rand_x = random.uniform(m_ctr['x'] -  1080, 
                                            m_ctr['x'] - 1020)
