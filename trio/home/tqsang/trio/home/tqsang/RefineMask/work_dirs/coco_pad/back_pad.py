...
data_root = '/home/zhanggang/RefineMask/data/coco'
data = dict(
    samples_per_gpu=2,
    workers_per_gpu=2,
    train=dict(
        type='CocoDataset',
        ann_file=
        '/home/tqsang/V100/tqsang/crop_obj/back_COCO_pad_synthetic_refine/annotations/instances_train2017.json',
        img_prefix=
        '/home/tqsang/V100/tqsang/crop_obj/back_COCO_pad_synthetic_refine/train2017/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='LoadAnnotations',
    ...
    val=dict(
        type='CocoDataset',
        ann_file=
        '/home/tqsang/V100/tqsang/crop_obj/back_COCO_pad_synthetic_refine/annotations/instances_val2017.json',
        img_prefix=
        '/home/tqsang/V100/tqsang/crop_obj/back_COCO_pad_synthetic_refine/val2017/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
