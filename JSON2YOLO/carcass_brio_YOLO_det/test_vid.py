...
model_path = '/home/tqsang/JSON2YOLO/carcass_brio_YOLO_det/runs/detect/yolov8x_brio_det_v4/weights/best.pt'
model = YOLO(model_path)

video_path_part1 = '/mnt/tqsang/dot1_vid/dot1_1.mp4'

output_path_part1 = '/mnt/tqsang/test_vid_v4.mp4'
