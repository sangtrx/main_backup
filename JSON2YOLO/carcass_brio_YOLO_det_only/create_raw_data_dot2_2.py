...
areas = {
    ...
    '16-17': [1462,660,1462+1000,660+1000],
    '18': [1451,674,1451+1000,674+1000],
    '19-20': [1385,669,1385+1000,669+1000],
    '21-36': [1185,611,1185+1300,611+1300],
}
...
for video_file in video_files:
    video_number = int(video_file.split('_')[3].split('.')[0])
